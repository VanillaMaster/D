 ...
 */
type ValueSanitizer$1 = (value: unknown) => unknown;
/** TemplateResult types */
declare const HTML_RESULT$1 = 1;
declare const SVG_RESULT$1 = 2;
type ResultType$1 = typeof HTML_RESULT$1 | typeof SVG_RESULT$1;
declare const ATTRIBUTE_PART$1 = 1;
declare const CHILD_PART$1 = 2;
declare const ELEMENT_PART$1 = 6;
declare const COMMENT_PART$1 = 7;
/**
 ...
 *
 */
type UncompiledTemplateResult$1<T extends ResultType$1 = ResultType$1> = {
    ['_$litType$']: T;
...
interface DirectiveParent$1 {
    _$parent?: DirectiveParent$1;
    _$isConnected: boolean;
    __directive?: Directive;
    __directives?: Array<Directive | undefined>;
}
declare class Template$1 {
    parts: Array<TemplatePart$1>;
    constructor({ strings, ['_$litType$']: type }: UncompiledTemplateResult$1, options?: RenderOptions$1);
    /** @nocollapse */
    static createElement(html: TrustedHTML, _options?: RenderOptions$1): HTMLTemplateElement;
}
interface Disconnectable$1 {
    _$parent?: Disconnectable$1;
    _$disconnectableChildren?: Set<Disconnectable$1>;
    _$isConnected: boolean;
}
/**
 ...
 */
declare class TemplateInstance$1 implements Disconnectable$1 {
    _$template: Template$1;
    _$parts: Array<Part$1 | undefined>;
    constructor(template: Template$1, parent: ChildPart$1);
    get parentNode(): Node;
    get _$isConnected(): boolean;
    _clone(options: RenderOptions$1 | undefined): Node;
    _update(values: Array<unknown>): void;
}
type AttributeTemplatePart$1 = {
    readonly type: typeof ATTRIBUTE_PART$1;
    readonly index: number;
    readonly name: string;
    readonly ctor: typeof AttributePart$1;
    readonly strings: ReadonlyArray<string>;
};
type ChildTemplatePart$1 = {
    readonly type: typeof CHILD_PART$1;
    readonly index: number;
};
type ElementTemplatePart$1 = {
    readonly type: typeof ELEMENT_PART$1;
    readonly index: number;
};
type CommentTemplatePart$1 = {
    readonly type: typeof COMMENT_PART$1;
    readonly index: number;
};
/**
 ...
 * TemplateParts.
 */
type TemplatePart$1 = ChildTemplatePart$1 | AttributeTemplatePart$1 | ElementTemplatePart$1 | CommentTemplatePart$1;
type Part$1 = ChildPart$1 | AttributePart$1 | PropertyPart$1 | BooleanAttributePart$1 | ElementPart$1 | EventPart$1;

declare class ChildPart$1 implements Disconnectable$1 {
    readonly type = 2;
    readonly options: RenderOptions$1 | undefined;
    _$committedValue: unknown;
    private _textSanitizer;
    get _$isConnected(): boolean;
    constructor(startNode: ChildNode, endNode: ChildNode | null, parent: TemplateInstance$1 | ChildPart$1 | undefined, options: RenderOptions$1 | undefined);
    /**
    ...
    _$setValue(value: unknown, directiveParent?: DirectiveParent$1): void;
    private _insert;
    private _commitNode;
    private _commitText;
...
declare class AttributePart$1 implements Disconnectable$1 {
     ...
     */
    readonly strings?: ReadonlyArray<string>;
    protected _sanitizer: ValueSanitizer$1 | undefined;
    get tagName(): string;
    get _$isConnected(): boolean;
    constructor(element: HTMLElement, name: string, strings: ReadonlyArray<string>, parent: Disconnectable$1, options: RenderOptions$1 | undefined);
}

declare class PropertyPart$1 extends AttributePart$1 {
    readonly type = 3;
}

declare class BooleanAttributePart$1 extends AttributePart$1 {
    readonly type = 4;
}

declare class EventPart$1 extends AttributePart$1 {
    readonly type = 5;
    constructor(element: HTMLElement, name: string, strings: ReadonlyArray<string>, parent: Disconnectable$1, options: RenderOptions$1 | undefined);
    handleEvent(event: Event): void;
}

declare class ElementPart$1 implements Disconnectable$1 {
    element: Element;
    readonly type = 6;
    _$committedValue: undefined;
    options: RenderOptions$1 | undefined;
    constructor(element: Element, parent: Disconnectable$1, options: RenderOptions$1 | undefined);
    get _$isConnected(): boolean;
 ...
 * `directive`.
 */
declare abstract class Directive implements Disconnectable$1 {
    constructor(_partInfo: PartInfo);
    get _$isConnected(): boolean;
    abstract render(...props: Array<unknown>): unknown;
    update(_part: Part$1, props: Array<unknown>): unknown;
}
